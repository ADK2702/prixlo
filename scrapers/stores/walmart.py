"""
scrapers/stores/walmart.py — Circulaire Walmart Canada via Flipp + API Walmart
===============================================================================
Walmart Canada utilise Flipp pour ses circulaires hebdomadaires.
Ce module collecte les données Walmart (Walmart, Walmart Supercentre).

Usage autonome:
  python -m scrapers.stores.walmart
"""
...
TARGET_MERCHANTS = {"Walmart", "Walmart Supercentre", "Walmart Canada"}
    ...
    for region, postal in POSTAL_CODES:
        ...
        for flyer in walmart_flyers:
            ...
            merchant_name = (
                ...
                else flyer.get("merchant_name", "Walmart")
            ) or "Walmart"
...
if __name__ == "__main__":
    ...
    print(f"\n✅ Walmart: {len(items)} items collectés", flush=True)
