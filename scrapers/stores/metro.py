"""
scrapers/stores/metro.py — Circulaire Metro via API publique Flipp
==================================================================
Metro inc. utilise Flipp pour ses bannières Metro, Metro Plus,
Super C et Food Basics. Ce module cible spécifiquement Metro.

Usage autonome:
  python -m scrapers.stores.metro

Sortie: liste de dicts compatibles avec le format CSV collector.py
"""
...
TARGET_MERCHANTS = {"Metro", "Metro Plus", "Super C", "Food Basics"}
    ...
    for region, postal in POSTAL_CODES:
        ...
        for flyer in target_flyers:
            ...
            merchant_name = (
                ...
                else flyer.get("merchant_name", "Metro")
            ) or "Metro"
...
if __name__ == "__main__":
    ...
    print(f"\n✅ Metro: {len(items)} items collectés", flush=True)
